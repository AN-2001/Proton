...
void MenuUpdate(IntType Delta)
{
    ...
    if (!TickDelta || (MouseKeys[M2] && !LastMouseKeys[M2])) {
        ...
        RendererTranslate(POINT(0, MENU_ITEM_OFFSET));
...
void MenuDraw()
{
    ...
    RendererPushTransform();
    RendererTranslate(AABB[AABB_TYPE_MENU_ITEM_2][0]);
    ...
    RendererPushTransform();
    RendererTranslate(AABB[AABB_TYPE_MENU_ITEM_3][0]);
    ...
    RendererPushTransform();
    RendererTranslate(AABB[AABB_TYPE_MENU_ITEM_4][0]);
