...
#define UI_BACKGROUND_COLOUR        HEX2COL(0x000000)
#define UI_BORDER_COLOUR            HEX2COL(0x000000)
#define TEXT_NHOVERED_COLOUR        HEX2COL(0x000000)
#define TEXT_HOVERED_COLOUR         HEX2COL(0x000000)
